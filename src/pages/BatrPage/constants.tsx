...
export const DEFAULT_TOP_LINKS: Bookmark[] = [
    { id: 't1', title: 'GitHub', url: 'https://github.com/batyrhan', initials: 'GH' },
    { id: 't2', title: 'Telegram', url: 'https://t.me', initials: 'TG' },
    { id: 't3', title: 'LinkedIn', url: 'https://linkedin.com', initials: 'LI' },
];

export const DEFAULT_BOOKMARKS: Bookmark[] = [
  { id: '1', title: 'YouTube', url: 'https://youtube.com', initials: 'YT' },
  { id: '2', title: 'GitHub', url: 'https://github.com', initials: 'GH' },
  { id: '3', title: 'Figma', url: 'https://figma.com', initials: 'FG' },
  { id: '4', title: 'ChatGPT', url: 'https://chat.openai.com', initials: 'AI' },
];
